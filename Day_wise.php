...
<section class="corona_updata container-fluid">
  <div class="my-3">
    <h3 class="text-uppercase text-center pt-5 pb-5" style="color:#F77620">covid-19 day wise live update</h3>
    
  </div>

  <div class="table-responsive">

    <table class="table text-center" id="tb">
...
<tr class="text-capitalize text-white">
	<th style="color: #fff; background: #f58414;">total confirmed</th>
	<th style="color: #fff; background: #2196f3;">daily confirmed</th>
	<th style="color: #fff; background: #ad0303;">Total Deaths</th>
	<th style="color: #fff; background: #2196f3;">daily Deaths</th>
	<th style="color: #fff; background: #1a821a;">total recovered</th>
	<th style="color: #fff; background: #2196f5;">daily recovered</th>
</tr>	
 
<tr class="mb-5">
	<td style="background: #f5bc14;"><?php echo $daywise['cases_time_series'][$i]['totalconfirmed'] . "<br>" ; ?> </td>

	<td style="background: #bed2f3;"><?php echo $daywise['cases_time_series'][$i]['dailyconfirmed'] . "<br>" ; ?> </td>

	
	<td style="background: #cf3434;"><?php echo $daywise['cases_time_series'][$i]['totaldeceased'] . "<br>" ; ?> </td>

	<td style="background: #bed2f3;"><?php echo $daywise['cases_time_series'][$i]['dailydeceased'] . "<br>" ; ?> </td>

    <td style="background: #46e346;"><?php	echo $daywise['cases_time_series'][$i]['totalrecovered'] . "<br>" ; ?> </td>

	<td style="background: #bed2f3;"><?php echo $daywise['cases_time_series'][$i]['dailyrecovered'] . "<br>" ; ?> </td>
