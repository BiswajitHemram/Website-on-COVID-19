  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto pr-5 text-uppercase ">
      <li class="nav-item active">
        <a class="nav-link" href="index.php" style="background-color:#03A5FC">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a class="nav-link" href="Contact_covid.php" style="background-color:#03A5FC">prevention</a>
          <li class="nav-item">
...
<section class="corona_updata container-fluid">
  <div class="mb-3">
    <h3  class="text-uppercase text-center pt-5 pb-5" style="color:#6699ff">covid-19 live update</h3>
