...
<div class="container-fluid  pt-5 pb-5" id="sympid">
  <div class="section_header text-center mb-5 mt-4">
    <h1 style="color:#40ff00" >Coronavirus New Symptoms</h1>
    
  </div>
  <div class="container">
    <div class="row">
    <div class="col-lg-4 col-md-4 col-12 mt-5">
      <figure class="text-center" style="color:#79ff4d">
      <img src="image/head.png" class="img-fluid" width="120" height="120">
    ...
    <div class="col-lg-4 col-md-4 col-12 mt-5">
      <figure class="text-center" style="color:#79ff4d">
      <img src="image/head (1).png" class="img-fluid" width="120" height="120">
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
      <figure class="text-center" style="color:#79ff4d">
      <img src="image/595fe8667aeb34291d8b461a.jpg" class="img-fluid" width="120" height="120">
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
      <figure class="text-center"  style="color:#79ff4d">
      <img src="image/human-chill-icon-vector-outline-illustration-human-chill-icon-vector-outline-human-chill-sign-isolated-contour-167835104.jpg" class="img-fluid" width="120" height="120">

      <figcaption>Repeated shaking with chills</figcaption>
...
<div class="col-lg-4 col-md-4 col-12 mt-5">
      <figure class="text-center" style="color:#79ff4d">
      <img src="image/black-and-white-letter-b-illustration-neck-pain-back-pain-body-ache-muscle-pain-joint-pain-back-pain-png-clip-art.png" class="img-fluid" width="120" height="120">

      <figcaption>Muscle pain</figcaption>
